...
- Embedded 112,660 AI research papers from OpenAlex into RAG pipeline (PostgreSQL + Qdrant)  
- Ingestion, storage, and retrieval services fully wired together with a basic UI
  
I now have a working RAG system. It's not enterprise-ready, embedding is painfully slow, and there's no fault-tolerace. However, it is a solid foundation and I am ready to move to the next sprint. 
...
| Q1 2026 | ▸ SharePoint integration, including ACL enforcement (event-driven, Graph API)                | Security services (threat modelling, PII redaction, audit logging) |
